 ...
 *******************************************************************************/
    ...
    #define                              MOD 
    #define PASS						 "Ordering is possible.\n"
    #define FAIL						 "The door cannot be opened.\n"
	...
	int main()
	{
		...
		For(i,0,t)
		{
			...
			For(j,0,26)
				if (outdeg[j]!=indeg[j])
					if (outdeg[j]==indeg[j]+1 || outdeg[j]+1==indeg[j])
						c++;
					else
					{
						flag = false;
