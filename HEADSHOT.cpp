 ...
 *******************************************************************************/
    ...
    int main()
    {
    	int i,j,k,n,m,count0,count1,count;
    	char str[105];
    	scs(str);
    	n=strlen(str);
    	...
    	For(i,0,n)
    	{
    		if(str[i]=='0' && i!= n-1)
    		{
    			count++;
    			if(str[i+1]=='0') count0++;
    			else if(str[i+1]=='1') count1++;
    		}
    		else if(str[i]=='0' && i == n-1)
    		{
    			count++;    		
    			if(str[0]=='0') count0++;
    			else if(str[0]=='1') count1++;
    		}
    	}
    	if(count0 == count1 || count == n) prs("EQUAL");
    	else if (count0 > count1) prs("SHOOT");
    	else prs("ROTATE");
    	return 0;
    }
